...
| [IP Address](/docs/widgets#public-ip) | `https://ipapi.co/json` | [IP API Privacy Policy](https://ipapi.co/privacy/) |
...
| [Cron Monitoring (Health Checks)](/docs/widgets#cron-monitoring-health-checks) | `https://healthchecks.io` | [Health-Checks Privacy Policy](https://healthchecks.io/privacy/) |
...
These can be combined with the `admin` and `normal` user roles to give fine-grained control. Admin users can save config changes and trigger app rebuilds, while normal users have read-only access. For more details, see the [Authentication Docs: Permissions](/docs/authentication#permissions).
