...
Then, where you want to get the user's value within your component, use something like: `this.appConfig.myProperty`. Don't forget to have a fallback or default when the user hasn't specified it.
