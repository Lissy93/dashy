  ...
  errors.forEach((error) => {
    ...
    switch (error.type) {
      ...
      case ValidationErrorTypes.SECTIONS_NOT_ARRAY:
        msg = `Validation Error: ${error.message} (path: ${error.path})`;
        break;
      ...
      case ValidationErrorTypes.ITEM_MISSING_TITLE:
        msg = `Validation Error: Item is missing required field 'title' (path: ${error.path})`;
        break;
      
      case ValidationErrorTypes.ITEM_MISSING_URL:
        msg = `Validation Error: Item is missing required field 'url' (path: ${error.path})`;
        break;
